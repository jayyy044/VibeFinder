...
const HomePage = () => {
    ...
    const GrabImage = async () => {
        try{
            ...
            // Prepare the image file for the OpenAI API
            const formData = new FormData();
            formData.append("file", blob, "uploaded_image.jpg");
            formData.append("purpose", "multimodal");

            // Upload the image to OpenAI first (if required)
            ...
            // Prepare the API request with the image file ID
            const genres = [
            ...
            const data = {
                ...
                messages: [
                    {
                        role: "user",
                        content: `Based on the image uploaded, suggest 3 genres from this list that best match the image: ${genres.join(', ')}`
                    }
                ],
                files: [{ id: fileId }],
                max_tokens: 200,
